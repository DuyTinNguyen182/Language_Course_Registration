...
const Overview = () => {
  ...
  //   const fetchStats = async () => {
  //     try {
  //       const res = await axios.get("http://localhost:3005/api/overview/stats", {
  ...
  //         axios.get("http://localhost:3005/api/overview/stats", {
  //           withCredentials: true,
  //         }),
  //         axios.get("http://localhost:3005/api/overview/revenue-stats", {
  //           withCredentials: true,
  //         }),
  //       ]);
  ...
  useEffect(() => {
    if (currentUser && currentUser.role === 'Admin') {
      ...
      // Nếu không phải admin, không làm gì cả hoặc set loading về false
      setLoading(false);
    }
