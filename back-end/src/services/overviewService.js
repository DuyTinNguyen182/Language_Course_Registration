...
//     { $match: { isPaid: true } }, // Chỉ lấy các đăng ký đã thanh toán
...
//   // 2. Lấy top 5 khóa học được đăng ký nhiều nhất
...
//   // 3. Số học viên mới trong 7 ngày qua
//   const sevenDaysAgo = new Date();
//   sevenDaysAgo.setDate(sevenDaysAgo.getDate() - 7);
//   const newStudentsLast7Days = await User.countDocuments({
//     role: "Student",
...
//     topCourses: topCourses, // Sẽ là một mảng [{ name: '...', count: ... }]
//     newStudents: newStudentsLast7Days,
//   };
// };
...
//   const revenuePipeline = [
//     // 1. Lọc các đăng ký đã thanh toán trong 7 ngày qua
//     {
//       $match: {
//         isPaid: true,
//         createdAt: { $gte: sevenDaysAgo },
//       },
//     },
//     // 2. Join với collection 'courses' để lấy thông tin học phí
//     {
//       $lookup: {
//         from: 'courses',
...
//     },
//     { $unwind: '$courseDetails' },
//     // 3. Nhóm theo ngày và tính tổng doanh thu mỗi ngày
//     {
//       $group: {
...
//     { $sort: { _id: 1 } },
//     // 5. Định dạng lại output cho dễ dùng ở frontend
//     {
//       $project: {
//         _id: 0,
//         date: '$_id',
...
//   const revenueData = await RegistrationCourse.aggregate(revenuePipeline);
//   return revenueData;
// };
