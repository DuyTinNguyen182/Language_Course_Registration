...
async function handleVnpayIpn(vnp_Params) {
  ...
  // cần lấy `Tuition` từ `course_id` để so sánh
  // const registrationWithCourse = await RegistrationCourse.findById(registrationId).populate('course_id');
  // if (registrationWithCourse.course_id.Tuition !== amountFromVnpay) {
